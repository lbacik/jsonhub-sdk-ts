...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JsonHubApi.ApiEntitiesGetCollection200Response();
  });
  ...
  describe('ApiEntitiesGetCollection200Response', function() {
    it('should create an instance of ApiEntitiesGetCollection200Response', function() {
      // uncomment below and update the code to test ApiEntitiesGetCollection200Response
      //var instance = new JsonHubApi.ApiEntitiesGetCollection200Response();
      //expect(instance).to.be.a(JsonHubApi.ApiEntitiesGetCollection200Response);
    });
