...
```typescript
import type { EntityJsonhalEntityReadEntityReadParent } from 'jsonhub-api-sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EntityJsonhalEntityReadEntityReadParent
