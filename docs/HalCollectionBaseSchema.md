...
```typescript
import type { HalCollectionBaseSchema } from 'jsonhub-sdk-ts'
...
const example = {
  ...
  "links": null,
  "itemsPerPage": null,
} satisfies HalCollectionBaseSchema
...
const exampleParsed = JSON.parse(exampleJSON) as HalCollectionBaseSchema
